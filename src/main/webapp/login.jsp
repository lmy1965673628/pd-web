    ...
    <div id="cover" class="rt">
        <form id="login-form" method="post" name="form1">
            <div class="txt">
                <p>登录学子商城
                    <span>
                        <a href="/user/toRegister.html">新用户注册</a>
                    </span>
                </p>
                <div class="text">
...
<script>
    $('#bt-login').click(function(){
        //读取用户的输入——表单序列化
        //form中有两个input username,password
        //username=180503&password=123456
