        ...
        <div class="all">
            ...
            <div id="sale_protection">
                ...
                <div class="sale_content">
                    ...
                    <p class="content">
                        商城向您保证所售商品均为正品行货，拼多自营商品开具机打发票或电子发票。
                    </p>
    ...
    $(function () {
        ...
        $(".avenge").each(function (i, item) {
            $(this).click(function (norms) {
                ...
                getItemId(color,norms,itemParamId);
                
                //}
            })
        })
        function getItemId(color,model,itemParamId)
        {
        ...
        $("#choose_color input").each(function (i, item) {
            $(this).click(function () {
                ...
                console.log(model);
                var itemParamId="${itemParamId}";
                getItemId(color,model,itemParamId);
