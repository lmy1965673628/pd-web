        ...
        <div id="box" >
            <div id="content_box">
                ...
                <div class="imfor">
                    ...
                    <div class="pudc">
                        <div class="pudc_information" id="${itemVO.pdItem.id}">
                        ...
                        var="itemParam">
                            <p class="col lf">
                            <span>${itemParam.key}：</span>
                            <span class="color_des">${itemParam.values[0]}  
                            <input type="hidden" name="" value="">
                            </span>
                            </p>
                            </c:forEach>
                    ...
                    <div class="pices">
                        <p class="pices_des">拼多专享价</p>
                        <p class="pices_information"><b>￥</b>
                        <span>${itemVO.pdItem.price}  <input type="hidden" name="" value=""></span></p>
                    </div>
                    <div class="num">
                    <span class="reduc">&nbsp;-&nbsp;</span>
                    <input type="text" value="${itemVO.pdCartItem.num}" ><span class="add">&nbsp;+&nbsp;</span></div>
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${itemVO.pdCartItem.num*itemVO.pdItem.price}</span>
                    </div>
                    <div class="del">
                        <!-- <div>
